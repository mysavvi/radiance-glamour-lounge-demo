...
with open("pages/clinic.html", "r") as f:
    html = f.read()
...
#         </div>
#       </section>
# BEFORE the <section class="rb-section rb-clinic-process"

pattern = re.compile(r'<section class="rb-section" aria-labelledby="rb-clinic-pillars-title">.*?(?:<section class="rb-section rb-clinic-process")', re.DOTALL)
...
grid_html = """<section class="rb-section" aria-labelledby="rb-clinic-pillars-title">
        <div class="neo-container">
          ...
          <ul class="neo-grid" style="margin-top: 32px; padding: 0;">
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/aesthetic-clinic-consultation-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/cosmetic-injectables-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/prp-vampire-facial-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/vampire-face-lift-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/plasma-pen-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/microneedling-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/jalupro-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/sunekos-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/aqualyx-fat-dissolving-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/chemical-peel-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/dermaplaning-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
            ...
            <li class="neo-grid-item" style="list-style: none;">
              <a href="/cosmetic-injectables-and-treatments-stockport/" style="text-decoration: none; color: inherit; display: block; transition: transform 0.3s ease;">
      ...
      <section class="rb-section rb-clinic-process"
"""

if pattern.search(html):
    new_html = pattern.sub(grid_html, html)
    with open("pages/clinic.html", "w") as f:
        f.write(new_html)
